...
//
// strong/em are rendered neutrally (no bold, no italic, no color shift) — the
// brand voice on /book is one calm gray; emphasis comes only from structural
// Bebas headers and the price line, not from inline authoring.
